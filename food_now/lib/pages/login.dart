...
import 'package:food_now/pages/forgotpassword.dart';
import 'package:food_now/pages/signup.dart';
...
TextEditingController useremailcontroler= new TextEditingController();
TextEditingController userpasswordcontroler= new TextEditingController();
        ...
        Container(
          ...
          child: Column(children: [
                      ...
                      onTap: (){
                        if(_formkey.currentState!.validate()){
                          setState(() {
                            ...
                            password= userpasswordcontroler.text;
                          });
                        }
                        userLogin();
                      },
            ...
            GestureDetector(
                ...
                child: Text("Don't have an account? Sign up", style: AppWidget.boldTextFeildStyle(),))
          ],),
        )
      ],),),
    );
